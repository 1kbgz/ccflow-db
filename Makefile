...
lint-py:  ## lint python with ruff
	python -m ruff check ccflow_db
	python -m ruff format --check ccflow_db
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix ccflow_db
	python -m ruff format ccflow_db
...
test:  ## run python tests
	python -m pytest -v ccflow_db/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v ccflow_db/tests --cov=ccflow_db --cov-report term-missing --cov-report xml
